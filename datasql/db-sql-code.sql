...
CREATE TABLE IF NOT EXISTS public.purchase (
    ...
    prch_contact character varying NOT NULL,
    prch_credit character varying NOT NULL,
    prch_down_payment character varying NOT NULL,
    prch_time_loan character varying NOT NULL,
    prch_pay_meathod character varying NOT NULL,
    prch_trade character varying NOT NULL,
    prch_custom character varying NOT NULL,
    ...
    CONSTRAINT fk_account FOREIGN KEY (account_id)
        REFERENCES public.account (account_id) ON UPDATE CASCADE ON DELETE CASCADE,
    
    CONSTRAINT fk_inventory FOREIGN KEY (inv_id)
        REFERENCES public.inventory (inv_id) ON UPDATE CASCADE ON DELETE CASCADE
);
